...
namespace ComplexCommerce.Data.SqlServer.Model
{
    ...
    //        };
    //        table.ForEach(x => context.Category.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.CategoryXProductXTenantLocale.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.Chain.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.Page.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.Product.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.ProductXTenantLocale.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.Tenant.AddObject(x));
    //        context.SaveChanges();
    //    }
    ...
    //        };
    //        table.ForEach(x => context.TenantLocale.AddObject(x));
    //        context.SaveChanges();
    //    }
    //}
}
