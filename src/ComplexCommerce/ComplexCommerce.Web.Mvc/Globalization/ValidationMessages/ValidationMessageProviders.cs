...
namespace ComplexCommerce.Web.Mvc.Globalization.ValidationMessages
{
    ...
    /// <para>
    /// Default setup is using <see cref="GriffinStringsProvider"/> as default and <see cref="MvcValidationMessageDataSource"/> + <see cref="DataAnnotationDefaultStrings"/> as fallback.
    /// </para>
    /// </remarks>
    ...
    /// ValidationMessageProviders.Add(new MvcValidationMessageDataSource());
    /// 
    ...
    public class ValidationMessageProviders
    {
        ...
        {
            Clear();
            Add(new ValidationMessageDataSource(new LocalizedStringProvider(new Business.Context.ApplicationContext())));
            Add(new MvcValidationMessageDataSource());
